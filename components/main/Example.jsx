...
const Example = () => {
  return (
    <>
      {" "}
      <div id="inicio" className="hidden sm:flex h-screen">
        <ParallaxProvider>
          <ParallaxBanner
            layers={[
              {
              ...
              },
              {
                speed: -20,
                children: (
                  <div className="absolute inset-0 flex items-center justify-end mr-16 mt-20 translate-y-28">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3  gap-4 bg-gradient-to-t from-[#000000d7] to-transparent translate-y-32">
                    <div className="col-end-4 text-white mt-[14rem] sm:ml-[-5rem] sm:w-11/12  w-10/12  ">
                      <h1 className="font-normal sm:text-2xl text-xl text-center sm:text-left">
                        ...
                        servicios y proyectos de{" "}
                        <span className="font-extrabold text-transparent text-3xl bg-clip-text bg-gradient-to-r from-green-400  to-cyan-400">
                          {" "}
                          Telecomunicaciones
                        </span>{" "}
