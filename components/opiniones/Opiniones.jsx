  ...
  return (
    <div className="bg-cover bgImage3 sm:h-[120vh] h-full">
      <video
        ...
        loop
        muted
        className="bg-cover xl:h-screen hidden sm:grid z-1 "
      />
<div className="relative top-[10vh] sm:top-[150px] md:top-[-450px] lg:top-[-600px] xl:top-[-500px] 2xl:top-[-900px]"> <div className="flex flex-col items-center text-[#2adc2f] font-bold text-3xl sm:4xl pt-10 pb-12 ">
      ...
      <div className="flex flex-col items-center text-[#2adc2f] font-bold text-3xl sm:4xl pt-10 pb-10">
       ...
       <h1 className="flex flex-col items-center text-[#2adc2f] font-bold text-3xl mb-10 pt-10">Casos de éxito</h1>
