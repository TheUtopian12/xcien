...
const Card = ({ titulo, imagen, descripcion, arrow, filtro }) => {
  return (
    <div className='flex justify-center group'>
      <div
        className={` border-solid  bg-[#050c13] group-hover:bg-white h-[350px]  sm:w-[90%] md:w-[98%] 2xl:w-[60%] w-[80%] rounded-2xl shadow-lg hover:shadow-[#3aa037] text-white group-hover:text-black`}
      >
